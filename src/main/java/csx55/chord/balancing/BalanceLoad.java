...
import csx55.chord.wireformats.Tasks;
...
public class BalanceLoad {
    ...
    public BalanceLoad(int numberOfNodesInOverlay, Peer computeNode, ConcurrentLinkedQueue<Task> tasks, StatisticsCollectorAndDisplay stats){
