...
import csx55.chord.dijkstra.RoutingCache;
import csx55.chord.dijkstra.ShortestPath;
import csx55.chord.wireformats.Message;
import csx55.chord.wireformats.Poke;
...
public class MessageSender implements Runnable {
    ...
    public MessageSender(Peer node, ConcurrentLinkedQueue<Message> messages, int[][] linkWeights, String[] names, StatisticsCollectorAndDisplay stats){
    ...
    public MessageSender(Peer node){
        this.node = node;
    }
