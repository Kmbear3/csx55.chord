...
import csx55.chord.wireformats.NodeTasks;
import csx55.chord.wireformats.RoundIncrement;
...
public class TaskManager implements Runnable{
    ...
    public TaskManager(int numberOfRounds, Peer node, ConcurrentLinkedQueue<Task> tasks, BalanceLoad balancer, int numberOfNodesInOverlay, StatisticsCollectorAndDisplay stats){
